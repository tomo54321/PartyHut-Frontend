...
export const SongRow: React.FC<SongRowProps> = ({
    ...
    <div className="flex flex-wrap sm:flex-nowrap md:space-x-3 pb-3 sm:pb-0 border-b border-gray-700 sm:border-b-0 items-center">
        ...
        <div className="space-y-1 w-full">
            <span className="block truncate w-28 lg:w-auto lg:max-w-xs xl:max-w-md 2xl:max-w-lg font-medium text-lg">{title}</span>
            <span className="block truncate w-28 lg:w-auto lg:max-w-xs xl:max-w-md 2xl:max-w-lg opacity-75">{artist}</span>
